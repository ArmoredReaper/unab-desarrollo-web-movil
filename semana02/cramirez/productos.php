    ...
    <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="img/product1.jpg" alt="Producto 1" class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="img/product2.jpg" alt="Producto 2" class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="img/product3.jfif" alt="Producto 3" class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="img/product4.jpg" alt="Producto 4" class="d-block w-100">
            </div>
