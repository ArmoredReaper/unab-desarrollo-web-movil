...
<html lang="es">
    ...
    <h1>Bienvenido Venta de autos</h1>

    <p>Selecciona una sección para continuar</p>

    <a href="empresa.php" class="btn btn-primary m-1">Empresa</a>
    <a href="productos.php" class="btn btn-primary m-1">Productos</a>
    <a href="servicios.php" class="btn btn-primary m-1">Servicios</a>
    <a href="contacto.php" class="btn btn-primary m-1">Contacto</a>
        ...
        <div class="container-fluid bg-dark">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4" style="color:white"><strong>autos@2026</strong></div>
                <div class="col-4"></div>
            </div>
        </div>
        <!-- Modal -->     
